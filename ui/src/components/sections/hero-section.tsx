  ...
  return (
    <section className="relative  overflow-hidden">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="items-center flex flex-col min-h-[60vh] space-y-8">
          <div className="space-y-6">
            <h1 className="text-5xl lg:text-6xl text-center font-bold text-gray-900 leading-tight">
            ...
            <p className="text-xl text-gray-600 text-center mx-auto leading-relaxed max-w-2xl">
