...
// Generate unique ID
const generateId = () => `testimonial-${Math.random().toString(36).substring(2, 11)}`;
							...
							{isExpanded && (
								<>
									<div className="space-y-2">
										<Label className="text-xs text-gray-500">Author Photo</Label>
										<ImageUpload
											value={item.icon}
									...
									<div className="space-y-2">
										<Label className="text-xs text-gray-500">Testimonial</Label>
										<Textarea
...
export default function TestimonialsSectionEditor({
	...
	const testimonials = section.gridItems || [];
	...
	const addItem = () => {
		...
		onUpdate({ ...section, gridItems: [...testimonials, newItem] });
	};
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<div className="space-y-2">
					...
					<Input
						...
						placeholder="e.g., Trusted by thousands of users"
					/>
				</div>
			</div>
